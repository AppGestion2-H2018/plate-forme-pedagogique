...
window.dhtmlXScheduler = window.scheduler = {version: "4.4.0"}, window.dhtmlx || (dhtmlx = function (e) {
    ...
    scheduler._waiAria = {
        getAttributeString: function (i) {
            ...
            return this.getAttributeString({
                role: "gridcell", "aria-label": [void 0 === t.label ? t.id : t.label, ": ", i]
            })
            ...
            this.setAttributes(i, {id: r}), this.setAttributes(a, {
                "aria-labelledby": r
            })
    ...
    date: {
        ...
        month_short: ["Jan", "Fév", "Mar", "Avr", "Mai", "Jui", "Jul", "Aoû", "Sep", "Oct", "Nov", "Déc"],
        ...
        confirm_closing: "",
        confirm_deleting: "Voulez-vous vraiment supprimer l'événement sélectionné ?",
...
scheduler.ical = {
    parse: function (e) {
        ...
        var r = a[0].substr(0, 4), s = parseInt(a[0].substr(4, 2), 10) - 1, n = a[0].substr(6, 2);
...
scheduler.formSection = function (e) {
    ...
    if (!this._lightbox) {
        ...
        t+="<div class='dhx_left_btn_set'><a href='/ajout-evenement' class='dhx_btn_set dhx_left_btn_set'>Plus d'options</a></div>"
